  ...
  <div className="left-col">
    <div className='co-text'>
            ...
            <div className='pro-txt reveal connect'>
              <div className='p-txt'><div><a href="https://github.com/R-LaRoi/" target= "_blank" alt="no alternative text"><i className="fa-brands fa-github icon"></i></a> <a href="https://www.linkedin.com/in/rachel-stroy-978397277" target= "_blank" alt="no alternative text">
